...
const progressoREACT = document.querySelectorAll(".barra div")[3];
progressoREACT.setAttribute("style", "width: 0%;"); 

const progressoMSQL = document.querySelectorAll(".barra div")[4];
progressoMSQL.setAttribute("style", "width: 0%;"); 

const progressoPYTHON = document.querySelectorAll(".barra div")[5];
